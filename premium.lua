...
local Window = Rayfield:CreateWindow({
   Name = "UnixHub",
   LoadingTitle = "Loading System Features...",
   LoadingSubtitle = "Coded By Muhammad Amzar",
   ConfigurationSaving = {
      Enabled = false,
...
-- Membina Tab Menu
local MainTab = Window:CreateTab("Basic", 4483362458)
local SpiritualTab = Window:CreateTab("Farm", 4483362458)
                      ...
                      if nameLabel and nameLabel:IsA("TextLabel") then
                          if nameLabel.Text == expectedText1 or nameLabel.Text == expectedText2 then
                              if player.Character and player.Character:FindFirstChild("HumanoidRootPart") then
                                  ...
                                  Rayfield:Notify({Name = "Berjaya", Content = "Teleport to Base Successful!", Duration = 3})
                                  baseFound = true
                                  break 
                              end
                          end
